 ...
 * This file demonstrates how to integrate Runeforge with a web frontend
 */

// For React/Vue/Angular applications
export class RuneforgeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new RuneforgeClient(provider, contractAddress);
